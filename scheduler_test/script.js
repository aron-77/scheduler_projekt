...
document.addEventListener("DOMContentLoaded", () => {
  ...
  addEventButton.addEventListener("click", () => {
    if (addEventWrapper.classList.contains("active")) {
      addEventWrapper.classList.remove("active"); // Hide the wrapper
    } else {
      addEventWrapper.classList.add("active"); // Show the wrapper
    }
  });

  // Optional: Hide the wrapper when clicking outside of it
  document.addEventListener("click", (event) => {
    if (
      !addEventWrapper.contains(event.target) &&
      !addEventButton.contains(event.target)
    ) {
      addEventWrapper.classList.remove("active");
    }
  });
